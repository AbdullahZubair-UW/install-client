...
sudo apt install zsh snap automake cmake pkg-config gettext exa curl fbreader feh fuse fontconfig gawk git gnumeric gnupg2 \
graphviz htop i3 i3lock imagemagick isync jq libnotify-bin libpq-dev libsqlite3-dev kitty make cmake cmatrix clang cpp coq mlocate \
...
texlive-full libcoq-mathcomp clangd ccls
